...
class ResourceController extends FOSRestController
{
    ...
    {
        // sprintf('%s_%s', $this->config->bundlePrefix, $this->config->resourceName);
        
        $resource = $this->createNew();  //Sylius\Bundle\CoreBundle\Model\Product
        $form = $this->getForm($resource); //Symfony\Component\Form\Form
        //now class Product is empty
