...
class SyliusAddressingBundle extends Bundle
{
    ...
    public function build(ContainerBuilder $container)
    {
        $interfaces = array(
            ...
            'Sylius\Bundle\AddressingBundle\Model\ChinaProvinceInterface'    => 'sylius.model.china_province.class',
            'Sylius\Bundle\AddressingBundle\Model\CityInterface'    => 'sylius.model.city.class',
            'Sylius\Bundle\AddressingBundle\Model\UniversityInterface'   => 'sylius.model.university.class',
            'Sylius\Bundle\AddressingBundle\Model\CampusInterface'       => 'sylius.model.campus.class',
        );
